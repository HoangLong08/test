...
const postExcelImportImageProductAction = createAsyncThunk(
  'products/postExcelImportImageProductAction',
  async (params: ParamPostUploadVideo, thunkAPI) => {
    try {
      const res = await upload.postExcelImportImageProduct(params);
      return res;
    } catch (error: any) {
...
export {
  ...
  postExcelImportImageProductAction,
};
